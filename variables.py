...
#Команды для старта
start_command = ['/start', '/launch', '/begin', '/forward', '/run', 'start', 'launch', 'begin', 'forward', 'run',
                 'restart', '/старт', 'старт', 'пуск', 'начать', 'привет', 'hello', '/go', 'go', 'вперед', 'вперёд', 'запуск', 'запуск бота',
                 'перезапуск бота', 'рестарт', 'перезапуск', 'вернуться в начало', 'начало', 'в начало',
                 'вернуться назад', 'сброс', '/cnfhn', 'cnfhn']
